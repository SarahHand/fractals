...
/**
 * Represents the data needed for a color scheme to color a point in the Julia set
 * @author J9465812
 */
public class JuliaPointData implements PointData{
	 ...
	 * @param allZValues
	 */
	public JuliaPointData(Double location, int escapeTime, List<ComplexNumber> allZValues){
