...
/**
 * The FractalEventHandler that represents the Mandelbrot Set.
 * @author J9465812
 *
 */
public class MandelbrotEventHandler implements FractalEventHandler{
	...
	public void mouseDragged(MouseEvent me){
		...
		viewer.setConfig(new MandelbrotConfig(newCenter, oldConfig.getZoom(), oldConfig.getMaxDwell(), ((MandelbrotConfig)oldConfig).getPalette(), oldConfig.getColorScheme()));
	...
	public void setColorPalette(ColorPalette palette){
		((MandelbrotConfig) viewer.getConfig()).setPalette(palette);
	}
	
	@Override
	public ColorPalette getColorPalette(){
		return ((MandelbrotConfig) viewer.getConfig()).getPalette();
	}
	...
	private void zoom(Dimension frameDimension, int xPos, int yPos,
		...
		MandelbrotConfig config = (MandelbrotConfig) viewer.getConfig();
		...
		MandelbrotConfig newConfig = new MandelbrotConfig(newCenter, newZoom, newMaxDwell, config.getPalette(), config.getColorScheme());
